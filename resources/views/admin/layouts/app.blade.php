...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin-assets/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.css') }}">

    <link rel="stylesheet"
          href="{{ asset('admin-assets/plugins/select2-bootstrap4-theme/select2-bootstrap4.css') }}">
    <link rel="stylesheet"
          href="{{ asset('admin-assets/plugins/select2/css/select2.css') }}">
...
{{--                            <li class="nav-item">--}}
{{--                                <a href="{{ route('admin.user.address') }}" class="nav-link {{ request()->is('admin/user/address') ? 'active' : '' }}">--}}
{{--                                    <i class="fas fa-plus-circle nav-icon"></i>--}}
{{--                                    <p>Создать пользователя</p>--}}
{{--                                </a>--}}
{{--                            </li>--}}
                    ...
                    <li class="nav-item {{ request()->is('admin/documents*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.documents.form.table') }}"
                                   class="nav-link {{ request()->is('admin/documents/form/*') ? 'active' : '' }}">
                                    <i class="fas fa-file nav-icon"></i>
                                    <p>Документы формы</p>
                                </a>
                            </li>
{{--                            <li class="nav-item">--}}
{{--                                <a href="{{ route('admin.documents.check.view') }}"--}}
{{--                                   class="nav-link {{ request()->is('admin/documents/check*') ? 'active' : '' }}">--}}
{{--                                    <i class="fas fa-check nav-icon"></i>--}}
{{--                                    <p>Проверка документов</p>--}}
{{--                                </a>--}}
{{--                            </li>--}}
                            <li class="nav-item">
                                <a href="{{ route('admin.documents.user.table') }}"
                                   class="nav-link {{ request()->is('admin/documents/user/*') ? 'active' : '' }}">
                                    <i class="fas fa-check nav-icon"></i>
                    ...
                    <li class="nav-item {{ request()->is('admin/invoice/*') ? 'active' : '' }}">
                        <a href="{{ route('admin.invoice.table') }}" class="nav-link">
                    ...
                    <li class="nav-item {{ request()->is('admin/package*') ? 'menu-open' : '' }}">
                        <a href="javascript:void(0)" class="nav-link">
                            <i class="nav-icon fas fa-user-alt"></i>
                            <p>
                                Посылки
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.package.table') }}" class="nav-link">
                                    <i class="fas fa-user-alt nav-icon"></i>
                                    <p>Все посылки</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.support.table') }}"
