    ...
    <div class="card col-12">
        ...
        <div class="card-body">
            <div class="d-flex flex-column gap-2">
                ...
                @if($product->options)
                    <p style="font-size: 16px; color: #020202">Опции: {{ $product->options }}</p>
                @endif
            ...
            <div class="mt-4 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('order.product.add-product', ['order_id' => $order->id]) }}" class="text-uppercase fw-semibold d-flex align-items-center gap-1">Все товары<i class='bx bx-right-arrow-alt fw-semibold'></i></a>
            </div>
        </div>
    </div>
</div>
