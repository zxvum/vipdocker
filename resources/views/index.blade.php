                            ...
                            <div
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end"
                                        ...
                                        <a class="dropdown-item" href="{{ route('package.all') }}">Все посылки</a>
                                        <a class="dropdown-item" href="{{ route('package.create') }}">Новая посылка</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end"
                                        ...
                                        <a class="dropdown-item" href="{{ route('order.table') }}">Все заказы</a>
                                        <a class="dropdown-item" href="{{ route('order.create') }}">Новый заказ</a>
                                    </div>
                                </div>
                            </div>
