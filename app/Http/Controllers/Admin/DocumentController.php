...
class DocumentController extends Controller
{
    ...
    public function allUsers(){
        ...
        return view('admin.documents.users.table');
    }

    public function createUserDocument(){
        return view('admin.documents.users.create');
    }

    public function createUserDocumentPost(Request $request){
        $request->validate([
            'user_id' => ['integer', 'exists:users,id'],
            'document_id' => ['integer', 'exists:documents,id'],
            'document' => ['file', 'image'],
            'status_id' => ['integer', 'exists:document_statuses,id']
        ]);
    }
    ...
    public function editUserDocument($id){
        ...
        return view('admin.documents.users.edit');
    }
}
